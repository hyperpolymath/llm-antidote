...
:experimental:
:url-github: https://github.com/hyperpolymath/llm-antidote
:url-gitlab: https://gitlab.com/hyperpolymath/llm-antidote
:url-bitbucket: https://bitbucket.org/hyperpolymath/llm-antidote
:url-codeberg: https://codeberg.org/hyperpolymath/llm-antidote

LLM hallucination detection and correction
...
llm-antidote is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
